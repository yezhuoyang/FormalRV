...
/-- **The wall.**  No amount of factory parallelism can drive the device spacetime below the
...
def babbush_ecc256_floor_qubit_hours : Nat := (90000000 * (2565 * 12000)) / 3600000000
