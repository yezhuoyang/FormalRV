...
namespace FormalRV.Framework.FTSchedule
...
structure FTSchedule where
  ...
  t_react_us      : Nat        -- real-time decoder reaction budget (qianxu ~1ms/cycle)
...
end FormalRV.Framework.FTSchedule
