...
open FormalRV.Framework.FTSchedule
...
/-! ## Reconciliation: the decoder-reaction budget is one quantity across all four records. -/
...
/-- The canonical projection agrees with `HardwareSensitivity`'s GE2021 instance and the
