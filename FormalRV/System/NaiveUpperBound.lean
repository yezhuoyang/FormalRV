...
open FormalRV.Framework FormalRV.Framework.Resource FormalRV.Framework.InvariantFramework
...
/-! ## (2) The verifiable upper bound: peak qubit demand never exceeds the
    ...
    induction on the step count — a genuine "∀ problem size" guarantee. -/
...
/-- THE UPPER BOUND: for every problem size `k`, the naive schedule's peak qubit
