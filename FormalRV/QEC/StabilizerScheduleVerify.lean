/-
  FormalRV.QEC.StabilizerScheduleVerify — let the USER specify their own
...
namespace FormalRV.QEC.StabilizerScheduleVerify
...
end FormalRV.QEC.StabilizerScheduleVerify
