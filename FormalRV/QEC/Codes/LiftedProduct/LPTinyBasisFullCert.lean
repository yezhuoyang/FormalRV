/-
  FormalRV\QEC\Codes\LiftedProduct\LPTinyBasisFullCert.lean — the LIST-LEVEL full-basis certificate for lpTinyImported
...
theorem lpTinyImportedBasis_valid : (lpTinyImportedBasis).valid = true := by decide
