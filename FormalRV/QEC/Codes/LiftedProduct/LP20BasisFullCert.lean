/-
  FormalRV\QEC\Codes\LiftedProduct\LP20BasisFullCert.lean — the LIST-LEVEL full-basis certificate for lp20Imported
...
-/
import FormalRV.QEC.Codes.LiftedProduct.LP20BasisImport
...
theorem lp20ImportedBasis_valid : (lp20ImportedBasis).valid = true := by decide
