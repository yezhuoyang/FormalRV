...
namespace FormalRV.Audit.GidneyEkera2021.NaiveBaselineCost
...
def naiveQubits : Nat :=
  FormalRV.Audit.GidneyEkera2021.WindowedShorPhysicalEstimate.windowedPhysicalDataQubits_rsa2048
...
end FormalRV.Audit.GidneyEkera2021.NaiveBaselineCost
