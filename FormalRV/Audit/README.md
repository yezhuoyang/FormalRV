...
| [`GidneyEkera2021`](GidneyEkera2021) | GE-2021 ([1905.09749](https://arxiv.org/abs/1905.09749)) | ➗ capstone axiom-free but `by decide` arithmetic resource reproduction (19.44M ≤ 20M; 8 h is 2–3× under the ceiling) — numbers flow through the verified `∀ model` area-law, not a closed semantic theorem; ✅ finite-zone invariants |
