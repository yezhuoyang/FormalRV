/-
  FormalRV.Audit.Common.SurfaceShorResourceCount — RESOURCE COUNT of the surface-code
...
namespace FormalRV.Audit.Common.SurfaceShorResourceCount
...
end FormalRV.Audit.Common.SurfaceShorResourceCount
