/-
  FormalRV.Audit.Common.ShorFullMachineRequirement — answers three questions about the
...
namespace FormalRV.Audit.Common.ShorFullMachineRequirement

open FormalRV.Audit.Common.ConcreteMachineFeasibility
...
end FormalRV.Audit.Common.ShorFullMachineRequirement
