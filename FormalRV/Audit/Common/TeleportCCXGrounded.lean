/-
  FormalRV.Audit.Common.TeleportCCXGrounded — GROUND the postulated `teleportCCXRel` in the
...
namespace FormalRV.Audit.Common.TeleportCCXGrounded
...
end FormalRV.Audit.Common.TeleportCCXGrounded
