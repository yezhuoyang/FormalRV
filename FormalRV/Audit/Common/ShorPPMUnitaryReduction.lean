/-
  FormalRV.Audit.Common.ShorPPMUnitaryReduction — turn the "unitary ∧ Boolean-PPM" CONJUNCTION
...
namespace FormalRV.Audit.Common.ShorPPMUnitaryReduction
...
end FormalRV.Audit.Common.ShorPPMUnitaryReduction
