/-
  FormalRV.Audit.Common.SurgeryDemoCNOT — a VERIFIED lattice-surgery CNOT and a VERIFIED CCX
...
namespace FormalRV.Audit.Common.SurgeryDemoCNOT
...
end FormalRV.Audit.Common.SurgeryDemoCNOT
