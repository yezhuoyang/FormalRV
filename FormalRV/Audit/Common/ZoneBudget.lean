/-
  FormalRV.Audit.Common.ZoneBudget — let the USER set their architecture's per-zone qubit
...
namespace FormalRV.Audit.Common.ZoneBudget
...
end FormalRV.Audit.Common.ZoneBudget
