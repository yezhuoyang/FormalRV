/-
  FormalRV.Audit.Common.StabilizerScheduleVerify — let the USER specify their own
...
namespace FormalRV.Audit.Common.StabilizerScheduleVerify
...
end FormalRV.Audit.Common.StabilizerScheduleVerify
