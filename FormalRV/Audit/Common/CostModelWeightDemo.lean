/-
  FormalRV.Audit.Common.CostModelWeightDemo — wiring the purpose-tagged ancilla budget
  to REAL code data.
...
namespace FormalRV.Audit.Common.CostModelWeightDemo

open FormalRV.Framework.Resource FormalRV.QEC FormalRV.QEC.Instances
open FormalRV.Audit.Common.GateSyndrome   -- `rowWeight`
...
end FormalRV.Audit.Common.CostModelWeightDemo
