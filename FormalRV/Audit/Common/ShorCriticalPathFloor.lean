/-
  FormalRV.Audit.Common.ShorCriticalPathFloor — the critical-path lower-bound MECHANISM
...
namespace FormalRV.Audit.Common.ShorCriticalPathFloor
...
end FormalRV.Audit.Common.ShorCriticalPathFloor
