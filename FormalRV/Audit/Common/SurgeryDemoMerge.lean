/-
  FormalRV.Audit.Common.SurgeryDemoMerge — a MULTI-PATCH lattice-surgery gadget on the
...
namespace FormalRV.Audit.Common.SurgeryDemoMerge
...
end FormalRV.Audit.Common.SurgeryDemoMerge
