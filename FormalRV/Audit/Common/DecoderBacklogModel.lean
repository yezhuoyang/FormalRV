/-
  FormalRV.Audit.Common.DecoderBacklogModel — a FULL PARAMETRIC model of the decoder
...
namespace FormalRV.Audit.Common.DecoderBacklogModel
...
end FormalRV.Audit.Common.DecoderBacklogModel
