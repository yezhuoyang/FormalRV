/-
  FormalRV.Audit.Common.WindowedShorPhysicalEstimate — the surface-code PHYSICAL resource bridge for
...
namespace FormalRV.Audit.Common.WindowedShorPhysicalEstimate
...
end FormalRV.Audit.Common.WindowedShorPhysicalEstimate
