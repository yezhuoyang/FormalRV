/-
  FormalRV.Audit.Common.ReactionLimitedRuntime — SELF-AUDIT finding #1: our "2.5× time
...
namespace FormalRV.Audit.Common.ReactionLimitedRuntime
...
end FormalRV.Audit.Common.ReactionLimitedRuntime
