/-
  FormalRV.Audit.Common.WindowedShorDeviceSchedule — the END-TO-END device schedule for windowed Shor,
...
namespace FormalRV.Audit.Common.WindowedShorDeviceSchedule
...
theorem rsa2048_schedule_budget :
    ...
    ∧ FormalRV.Audit.Common.WindowedShorPhysicalEstimate.windowedPhysicalDataQubits_rsa2048 = 9633792 := by
  refine ⟨rfl, FormalRV.System.MagicScheduleComplete.rsa2048_factories_value,
          FormalRV.Audit.Common.WindowedShorPhysicalEstimate.windowedPhysicalDataQubits_rsa2048_value⟩

end FormalRV.Audit.Common.WindowedShorDeviceSchedule
