/-
  FormalRV.Audit.Common.ResourceAuditGaps — the SELF-AUDIT's uncounted-cost findings,
...
namespace FormalRV.Audit.Common.ResourceAuditGaps
...
end FormalRV.Audit.Common.ResourceAuditGaps
