/-
  FormalRV.Audit.Common.WindowedShorPPMFactoryE2E — descend the VERIFIED windowed Shor modular
...
namespace FormalRV.Audit.Common.WindowedShorPPMFactoryE2E
...
end FormalRV.Audit.Common.WindowedShorPPMFactoryE2E
