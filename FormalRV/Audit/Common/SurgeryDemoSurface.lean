/-
  FormalRV.Audit.Common.SurgeryDemoSurface — a concrete LDPC lattice-surgery gadget
...
namespace FormalRV.Audit.Common.SurgeryDemoSurface
...
end FormalRV.Audit.Common.SurgeryDemoSurface
