/-
  FormalRV.Audit.Common.ShorEmitDistance — toward the north star: emit the FULL Shor(N,a)
...
namespace FormalRV.Audit.Common.ShorEmitDistance
...
open FormalRV.Audit.Common.ShorEmit
...
end FormalRV.Audit.Common.ShorEmitDistance
