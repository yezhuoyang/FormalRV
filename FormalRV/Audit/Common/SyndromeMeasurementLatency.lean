/-
  FormalRV.Audit.Common.SyndromeMeasurementLatency — syndrome-extraction overhead made
...
namespace FormalRV.Audit.Common.SyndromeMeasurementLatency
...
end FormalRV.Audit.Common.SyndromeMeasurementLatency
