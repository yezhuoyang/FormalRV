/-
  FormalRV.Audit.Common.SurgeryDemoSteane — concrete LDPC lattice
...
namespace FormalRV.Audit.Common.SurgeryDemoSteane
...
end FormalRV.Audit.Common.SurgeryDemoSteane
