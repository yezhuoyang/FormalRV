/-
  FormalRV.Audit.Common.SurfaceShorPPMEndToEnd — the capstone of Path A: PPM-based
...
namespace FormalRV.Audit.Common.SurfaceShorPPMEndToEnd
...
end FormalRV.Audit.Common.SurfaceShorPPMEndToEnd
