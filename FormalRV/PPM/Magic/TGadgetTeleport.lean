/-
  FormalRV.PPM.Magic.TGadgetTeleport — the REAL T gate-teleportation gadget.
...
namespace FormalRV.PPM.Magic.TGadgetTeleport
...
end FormalRV.PPM.Magic.TGadgetTeleport
