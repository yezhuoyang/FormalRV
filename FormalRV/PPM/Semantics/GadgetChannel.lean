/-
  FormalRV.PPM.Semantics.GadgetChannel — GAPS 1–4 (gadget channel), CLOSED for the T gate;
...
-/
import FormalRV.PPM.Magic.MagicGadgetInterface
...
open FormalRV.PPM.Magic.MagicGadgetInterface
open Complex

namespace FormalRV.PPM.Semantics.GadgetChannel
...
end FormalRV.PPM.Semantics.GadgetChannel
