...
/-! ## Reuse policy
    ...
    * `PPMSpec.measuredPauliKind : PauliKind`  — reuses the
      existing `FormalRV.Framework.Architecture.PauliKind`
    ...
    * `PauliString` — both
      `FormalRV.Framework.Architecture.PauliString` (list
...
/-! ## §2.b Adapter from existing `PauliMeasurementClaim`.
    ...
    `FormalRV.Framework.Architecture.PauliMeasurementClaim`
