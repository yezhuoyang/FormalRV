/-
  FormalRV.PPM.Compiler.PPMGadgetInstance — an inhabitation witness for
  `PPMGadgetInterface`.
...
-/
import FormalRV.PPM.Compiler.PPMCompilerCorrectness

open scoped Matrix
open FormalRV.Framework
open FormalRV.Framework.CliffordTRotations

namespace FormalRV.PPM.Compiler.PPMGadgetInstance

open FormalRV.PPM.Compiler.PPMCompilerCorrectness
...
end FormalRV.PPM.Compiler.PPMGadgetInstance
