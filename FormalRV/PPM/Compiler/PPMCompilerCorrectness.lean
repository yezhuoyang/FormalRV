...
--   * FormalRV.PPM.Semantics.PPMDenote      -- gadgetDenote/gadgetDenote_eq, StateVec, the
...
-- ===========================================================================
import FormalRV.PPM.Semantics.PPMDenote
...
namespace FormalRV.PPM.Compiler.PPMCompilerCorrectness
...
theorem tGadget_denote_eq_frame_apply
    (U proj corr : Matrix (Fin 4) (Fin 4) ℂ)
    (ψ res : StateVec 1) :
    FormalRV.PPM.Semantics.PPMDenote.gadgetDenote U proj corr ψ res
      = ((corr * proj) * U) * (ψ ⊗ᵥ res) := by
  rw [FormalRV.PPM.Semantics.PPMDenote.gadgetDenote_eq, Matrix.mul_assoc]
...
end FormalRV.PPM.Compiler.PPMCompilerCorrectness