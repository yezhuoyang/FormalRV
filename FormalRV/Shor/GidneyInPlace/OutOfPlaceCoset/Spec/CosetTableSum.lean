/-
  FormalRV.Shor.GidneyInPlace.CosetTableSum — the windowed table-sum (endian audit)
...
namespace FormalRV.Shor.GidneyInPlace.CosetTableSum

open FormalRV.SQIRPort
open FormalRV.SQIRPort.ApproxTransfer
open FormalRV.Shor.GidneyInPlace.ApproxOp (cosetState)
open FormalRV.Shor.GidneyInPlace.CosetMul (idealAcc actualAcc cosetMul_superposition_deviation)
open FormalRV.Shor.GidneyInPlace.ControlledLift (branchOf)
...
end FormalRV.Shor.GidneyInPlace.CosetTableSum
