/-
  FormalRV.Shor.GidneyInPlace.CosetFoldWindowed — the windowed multiplier embedding:
...
-/
import FormalRV.Shor.GidneyInPlace.OutOfPlaceCoset.Proof.CosetFold
import FormalRV.Shor.GidneyInPlace.OutOfPlaceCoset.Spec.CosetTableSum

namespace FormalRV.Shor.GidneyInPlace.CosetFoldWindowed
...
open FormalRV.Shor.GidneyInPlace.CosetMul (idealAcc runningSum)
open FormalRV.Shor.GidneyInPlace.CosetTableSum (cosetWindowConst cosetWindowConst_lt idealAcc_cosetWindowConst)
open FormalRV.Shor.GidneyInPlace.CosetFold (cosetState_multiWrap_agree_off)
...
end FormalRV.Shor.GidneyInPlace.CosetFoldWindowed
