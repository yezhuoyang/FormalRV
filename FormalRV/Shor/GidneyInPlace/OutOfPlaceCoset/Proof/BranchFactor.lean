/-
  FormalRV.Shor.GidneyInPlace.BranchFactor — the REUSABLE control×data branch
...
namespace FormalRV.Shor.GidneyInPlace.BranchFactor

open FormalRV.SQIRPort
open FormalRV.SQIRPort.ApproxTransfer
open FormalRV.Shor.GidneyInPlace.ControlledLift (normSqDist_smul branchOf)
...
end FormalRV.Shor.GidneyInPlace.BranchFactor
