/-
  FormalRV.Shor.GidneyInPlace.CosetDeviationE — the coset out-of-place deviation
...
namespace FormalRV.Shor.GidneyInPlace.CosetDeviationE

open FormalRV.SQIRPort
open FormalRV.SQIRPort.ApproxTransfer
open FormalRV.Shor.GidneyInPlace.ApproxOp (cosetState)
open FormalRV.Shor.GidneyInPlace.BranchFactor
  (branchOfE normSqDist_branchOfE_controlled_lift_subnormalized)
open FormalRV.Shor.GidneyInPlace.CosetMul (actualAcc idealAcc cosetMulOutOfPlace_deviation)
...
end FormalRV.Shor.GidneyInPlace.CosetDeviationE
