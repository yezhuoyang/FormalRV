/-
  FormalRV.Shor.GidneyInPlace.CosetRunwayStep — the concrete NON-MODULAR runway
...
namespace FormalRV.Shor.GidneyInPlace.CosetRunwayStep
...
end FormalRV.Shor.GidneyInPlace.CosetRunwayStep
