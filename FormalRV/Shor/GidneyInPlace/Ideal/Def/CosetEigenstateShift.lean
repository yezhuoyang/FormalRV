/-
  FormalRV.Shor.GidneyInPlace.CosetEigenstateShift — obligation (2), checkpoint 2 START:
...
namespace FormalRV.Shor.GidneyInPlace.CosetEigenstateShift
...
end FormalRV.Shor.GidneyInPlace.CosetEigenstateShift
