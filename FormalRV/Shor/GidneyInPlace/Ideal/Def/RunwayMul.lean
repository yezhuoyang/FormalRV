/-
  FormalRV.Shor.GidneyInPlace.RunwayMul — the RUNWAY-PRESERVING coset multiplier (the
...
namespace FormalRV.Shor.GidneyInPlace.RunwayMul
...
end FormalRV.Shor.GidneyInPlace.RunwayMul
