/-
  FormalRV.Shor.GidneyInPlace.RunwayIntertwine — the direct EmbedAgree route: the
...
-/
import FormalRV.Shor.GidneyInPlace.Ideal.Def.RunwayMul

namespace FormalRV.Shor.GidneyInPlace.RunwayIntertwine
...
end FormalRV.Shor.GidneyInPlace.RunwayIntertwine
