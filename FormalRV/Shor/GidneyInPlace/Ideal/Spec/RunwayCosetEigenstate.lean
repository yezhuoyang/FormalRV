/-
  FormalRV.Shor.GidneyInPlace.RunwayCosetEigenstate — the EIGENSTATE ASSEMBLY: the coset
...
-/
import FormalRV.Shor.GidneyInPlace.Ideal.Def.CosetEigenstateShift
import FormalRV.Shor.GidneyInPlace.Primitives.Def.ApproxOp

namespace FormalRV.Shor.GidneyInPlace.RunwayCosetEigenstate

open scoped BigOperators
open FormalRV.SQIRPort
open FormalRV.Shor.GidneyInPlace.ApproxOp (cosetState)
open FormalRV.Shor.GidneyInPlace.CosetEigenstateShift (eigenstate_rootOfUnity)
...
end FormalRV.Shor.GidneyInPlace.RunwayCosetEigenstate
