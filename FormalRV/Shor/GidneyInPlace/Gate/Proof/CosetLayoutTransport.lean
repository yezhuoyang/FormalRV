/-
  FormalRV.Shor.GidneyInPlace.CosetLayoutTransport — option (ii): the layout-conjugation
...
namespace FormalRV.Shor.GidneyInPlace.CosetLayoutTransport
...
end FormalRV.Shor.GidneyInPlace.CosetLayoutTransport
