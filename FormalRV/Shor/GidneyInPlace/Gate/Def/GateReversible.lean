/-
  FormalRV.Shor.GidneyInPlace.GateReversible — reversibility of the gate IR.
  ════════════════════════════════════════════════════════════════════════════
...
namespace FormalRV.Shor.GidneyInPlace.GateReversible
...
end FormalRV.Shor.GidneyInPlace.GateReversible
