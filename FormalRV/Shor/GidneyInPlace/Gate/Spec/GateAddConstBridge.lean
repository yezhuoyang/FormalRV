/-
  FormalRV.Shor.GidneyInPlace.GateAddConstBridge — the gate-connection layer: a
...
namespace FormalRV.Shor.GidneyInPlace.GateAddConstBridge
...
end FormalRV.Shor.GidneyInPlace.GateAddConstBridge
