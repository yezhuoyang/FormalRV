/-
  FormalRV.Shor.GidneyInPlace.UCEvalBridge — the abstract basis permutation
...
namespace FormalRV.Shor.GidneyInPlace.UCEvalBridge
...
end FormalRV.Shor.GidneyInPlace.UCEvalBridge
