/-
  FormalRV.Shor.GidneyInPlace.ReducedLookupCosetGate — the REDUCED-LOOKUP windowed
...
-- NOTE: transitively load-bearing (provides the WindowedModNShor namespace +
-- copyWindow/lookupReadAt/foldl_seq well-typedness lemmas used below), not just docs.
import FormalRV.Shor.GidneyInPlace.OutOfPlaceCoset.Spec.CosetTableSum

namespace FormalRV.Shor.GidneyInPlace.ReducedLookupCosetGate
...
end FormalRV.Shor.GidneyInPlace.ReducedLookupCosetGate
