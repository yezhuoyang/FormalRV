/-
  FormalRV.Shor.GidneyInPlace.InPlaceCosetClearing — CHECKPOINT 3 of the in-place phase:
...
namespace FormalRV.Shor.GidneyInPlace.InPlaceCosetClearing

open FormalRV.Framework FormalRV.Framework.Gate FormalRV.BQAlgo
open FormalRV.Shor.WindowedCircuit
open FormalRV.Shor.WindowedArith (tableValue window)
open FormalRV.Shor.GidneyInPlace.ReducedLookupCosetGate (cosetModMulCircuitOf)
open FormalRV.Shor.GidneyInPlace.ReducedLookupStepAction (stepInv_determines_mulInputAccOf)
open FormalRV.Shor.GidneyInPlace.ReducedLookupCosetValue (idealAcc_eq_sum_mod)
...
open FormalRV.Shor.GidneyInPlace.InPlaceCosetGate (inplaceCosetGate inplaceCosetGate_unfold)
...
end FormalRV.Shor.GidneyInPlace.InPlaceCosetClearing
