/-
  FormalRV.Shor.GidneyInPlace.InPlaceCosetSpec — THE SOLE REMAINING CONCRETE FRONTIER:
...
namespace FormalRV.Shor.GidneyInPlace.InPlaceCosetSpec
...
end FormalRV.Shor.GidneyInPlace.InPlaceCosetSpec
