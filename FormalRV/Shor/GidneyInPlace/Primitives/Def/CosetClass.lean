/-
  FormalRV.Shor.GidneyInPlace.CosetClass — the coset WINDOW (Zalka/Gidney).
  ════════════════════════════════════════════════════════════════════════════
...
namespace FormalRV.Shor.GidneyInPlace.CosetClass
...
end FormalRV.Shor.GidneyInPlace.CosetClass
