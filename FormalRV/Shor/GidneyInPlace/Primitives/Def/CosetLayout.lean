/-
  FormalRV.Shor.GidneyInPlace.CosetLayout — the explicit two-register layout for the
...
namespace FormalRV.Shor.GidneyInPlace.CosetLayout
...
end FormalRV.Shor.GidneyInPlace.CosetLayout
