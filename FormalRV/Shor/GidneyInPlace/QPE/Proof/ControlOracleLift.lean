/-
  FormalRV.Shor.GidneyInPlace.ControlOracleLift — lemmas 2 + 3 - the live engine's `hc_local` and `hintertwine` for the
...
namespace FormalRV.Shor.GidneyInPlace.ControlOracleLift
...
open FormalRV.Shor.GidneyInPlace.CosetEphys (E_phys E_phys_acts cosetEmbedMat)
...
end FormalRV.Shor.GidneyInPlace.ControlOracleLift
