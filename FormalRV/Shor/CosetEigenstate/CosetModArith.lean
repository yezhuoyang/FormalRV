/-
  FormalRV.Shor.CosetEigenstate.CosetModArith — modular arithmetic for the inverse
...
namespace FormalRV.Shor.CosetEigenstate.CosetModArith
...
end FormalRV.Shor.CosetEigenstate.CosetModArith
