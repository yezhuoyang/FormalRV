/-
  FormalRV.Shor.CosetEigenstate.ReducedLookupEgate — e_gate (reusable named product equiv) + one-pass branchOfE coset action.
-/
...
namespace FormalRV.Shor.CosetEigenstate.ReducedLookupEgate
...
open FormalRV.Shor.CosetEigenstate.ReducedLookupStepAction
open FormalRV.Shor.CosetEigenstate.GatePerm
open FormalRV.Shor.CosetEigenstate.CuccaroGatePerm (gateToPerm_funboolNat)
open FormalRV.Shor.CosetEigenstate.ApproxOp (cosetState permState shiftState shiftState_cosetState)
...
open FormalRV.Shor.CosetEigenstate.ApproxOp (wrapShiftState wrapShiftState_cosetState)
...
end FormalRV.Shor.CosetEigenstate.ReducedLookupEgate