/-
  FormalRV.Shor.CosetEigenstate.QPEStageDecomp — QPE STAGE-DECOMPOSITION (oracle abstract).
...
namespace FormalRV.Shor.CosetEigenstate.QPEStageDecomp

open FormalRV.SQIRPort
open FormalRV.Shor.CosetEigenstate.EmbedOrbitCompose (orbitState)
...
end FormalRV.Shor.CosetEigenstate.QPEStageDecomp
