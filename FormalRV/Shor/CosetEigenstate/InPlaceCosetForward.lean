/-
  FormalRV.Shor.CosetEigenstate.InPlaceCosetForward — CHECKPOINT 2 of the in-place phase:
...
namespace FormalRV.Shor.CosetEigenstate.InPlaceCosetForward

open FormalRV.Framework FormalRV.Framework.Gate FormalRV.BQAlgo
open FormalRV.SQIRPort
open FormalRV.SQIRPort.ApproxTransfer (normSqDist)
open FormalRV.Shor.CosetEigenstate.ReducedLookupCosetGate (cosetModMulCircuitOf cosetDim)
open FormalRV.Shor.CosetEigenstate.ReducedLookupEgate (cosetInput)
open FormalRV.Shor.CosetEigenstate.CosetMul (runningSum)
open FormalRV.Shor.CosetEigenstate.CosetTableSum (cosetWindowConst)
open FormalRV.Shor.CosetEigenstate.ReducedLookupCosetShift
...
end FormalRV.Shor.CosetEigenstate.InPlaceCosetForward
