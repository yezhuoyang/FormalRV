/-
  FormalRV.Shor.CosetEigenstate.ReducedLookupStepAction — gate-specific BASIS one-step action for ONE reduced window step
...
namespace FormalRV.Shor.CosetEigenstate.ReducedLookupStepAction
...
open FormalRV.Shor.CosetEigenstate.UCEvalBridge
open FormalRV.Shor.CosetEigenstate.CuccaroGatePerm
...
end FormalRV.Shor.CosetEigenstate.ReducedLookupStepAction