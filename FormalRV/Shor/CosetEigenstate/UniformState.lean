/-
  FormalRV.Shor.CosetEigenstate.UniformState — the uniform-superposition state.
  ════════════════════════════════════════════════════════════════════════════
...
namespace FormalRV.Shor.CosetEigenstate.UniformState
...
end FormalRV.Shor.CosetEigenstate.UniformState
