/-
  FormalRV.Shor.CosetEigenstate.PhaseMarginalLift — the compositional QPE marginal
...
namespace FormalRV.Shor.CosetEigenstate.PhaseMarginalLift
...
end FormalRV.Shor.CosetEigenstate.PhaseMarginalLift
