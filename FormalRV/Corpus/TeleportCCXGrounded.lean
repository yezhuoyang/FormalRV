/-
  FormalRV.Corpus.TeleportCCXGrounded — GROUND the postulated `teleportCCXRel` in the
...
namespace FormalRV.Corpus.TeleportCCXGrounded
...
end FormalRV.Corpus.TeleportCCXGrounded
