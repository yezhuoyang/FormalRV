/-
  FormalRV.Corpus.DecodeLatencySensitivity — make the DECODE LATENCY a first-class
...
namespace FormalRV.Corpus.DecodeLatencySensitivity
...
open FormalRV.Corpus.DecoderBacklogModel in
...
end FormalRV.Corpus.DecodeLatencySensitivity
