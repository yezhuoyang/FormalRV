/-
  FormalRV.Corpus.ShorOnLPBridge — connect the Shor-algorithm island to the LP-code island
...
open FormalRV.Corpus.ShorModMulPPMFactoryE2E
open FormalRV.Corpus.ShorPPMEndToEnd
...
theorem multiplier_gateset_bridges_to_LP
  ...
  ⟨FormalRV.Corpus.ShorPPMUnitaryReduction.ppm_clifford_run_eq_applyNat F g hICX f σ' hrun,
   (FormalRV.Corpus.TeleportCCXGrounded.teleportCCX_grounded_in_verified_clifford_T
      F a b c s t hac hbc h).1⟩

end FormalRV.Corpus.ShorOnLPBridge
