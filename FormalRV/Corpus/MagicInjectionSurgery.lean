/-
  FormalRV.Corpus.MagicInjectionSurgery — `teleportCCX` → magic-injection LATTICE
...
namespace FormalRV.Corpus.MagicInjectionSurgery
...
end FormalRV.Corpus.MagicInjectionSurgery
