/-
  FormalRV.Corpus.ConcreteMachineFeasibility — "can THIS concrete machine factor
...
namespace FormalRV.Corpus.ConcreteMachineFeasibility
...
end FormalRV.Corpus.ConcreteMachineFeasibility
