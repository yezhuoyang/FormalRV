/-
  FormalRV.Corpus.SurfaceShorFullStack — the SCHEDULE-LEVEL capstone of Path A:
...
namespace FormalRV.Corpus.SurfaceShorFullStack
...
end FormalRV.Corpus.SurfaceShorFullStack
