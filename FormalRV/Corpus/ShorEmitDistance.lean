/-
  FormalRV.Corpus.ShorEmitDistance — toward the north star: emit the FULL Shor(N,a)
...
namespace FormalRV.Corpus.ShorEmitDistance
...
end FormalRV.Corpus.ShorEmitDistance
