/-
  FormalRV.Corpus.ShorFullMachineRequirement — answers three questions about the
...
namespace FormalRV.Corpus.ShorFullMachineRequirement

open FormalRV.Corpus.ConcreteMachineFeasibility
...
end FormalRV.Corpus.ShorFullMachineRequirement
