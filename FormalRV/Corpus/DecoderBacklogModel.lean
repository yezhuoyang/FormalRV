/-
  FormalRV.Corpus.DecoderBacklogModel — a FULL PARAMETRIC model of the decoder
...
namespace FormalRV.Corpus.DecoderBacklogModel
...
end FormalRV.Corpus.DecoderBacklogModel
