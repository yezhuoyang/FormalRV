/-
  FormalRV.Corpus.SurfaceShorPPMEndToEnd — the capstone of Path A: PPM-based
...
namespace FormalRV.Corpus.SurfaceShorPPMEndToEnd
...
end FormalRV.Corpus.SurfaceShorPPMEndToEnd
