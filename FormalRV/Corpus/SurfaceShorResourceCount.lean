/-
  FormalRV.Corpus.SurfaceShorResourceCount — RESOURCE COUNT of the surface-code
...
namespace FormalRV.Corpus.SurfaceShorResourceCount
...
end FormalRV.Corpus.SurfaceShorResourceCount
