/-
  FormalRV.Corpus.ResourceAuditGaps — the SELF-AUDIT's uncounted-cost findings,
...
namespace FormalRV.Corpus.ResourceAuditGaps
...
end FormalRV.Corpus.ResourceAuditGaps
