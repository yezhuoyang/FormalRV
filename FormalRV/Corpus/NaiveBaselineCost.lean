/-
  FormalRV.Corpus.NaiveBaselineCost — concrete running-time and qubit numbers for the verified
...
namespace FormalRV.Corpus.NaiveBaselineCost
...
def naiveQubits : Nat :=
  FormalRV.Corpus.WindowedShorPhysicalEstimate.windowedPhysicalDataQubits_rsa2048
...
end FormalRV.Corpus.NaiveBaselineCost
