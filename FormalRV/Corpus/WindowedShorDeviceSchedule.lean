/-
  FormalRV.Corpus.WindowedShorDeviceSchedule — the END-TO-END device schedule for windowed Shor,
...
namespace FormalRV.Corpus.WindowedShorDeviceSchedule
...
theorem rsa2048_schedule_budget :
    ...
    ∧ FormalRV.Corpus.WindowedShorPhysicalEstimate.windowedPhysicalDataQubits_rsa2048 = 9633792 := by
  refine ⟨rfl, FormalRV.System.MagicScheduleComplete.rsa2048_factories_value,
          FormalRV.Corpus.WindowedShorPhysicalEstimate.windowedPhysicalDataQubits_rsa2048_value⟩

end FormalRV.Corpus.WindowedShorDeviceSchedule
