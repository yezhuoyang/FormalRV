...
def main : IO Unit := do
  ...
  emit "modmult_const_2_15_7"  (modmult_const_gate 2 15 7)
  emit "modmult_const_3_21_5"  (modmult_const_gate 3 21 5)
  ...
  emit "modmult_MCP_2_15_7_13" (modmult_MCP_gate 2 15 7 13)
  ...
  emit "ctrl_const_2_15_7"     (ctrlGate 100 101 (modmult_const_gate 2 15 7))
  emit "ctrl_MCP_2_15_7_13"    (ctrlGate 100 101 (modmult_MCP_gate 2 15 7 13))
